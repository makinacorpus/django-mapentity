...
MODELTRANSLATION_LANGUAGES = [x[0] for x in settings.LANGUAGES]
MODELTRANSLATION_DEFAULT_LANGUAGE = MODELTRANSLATION_LANGUAGES[0]
setattr(settings, 'MODELTRANSLATION_LANGUAGES', MODELTRANSLATION_LANGUAGES)
setattr(settings, 'MODELTRANSLATION_DEFAULT_LANGUAGE', MODELTRANSLATION_DEFAULT_LANGUAGE)
